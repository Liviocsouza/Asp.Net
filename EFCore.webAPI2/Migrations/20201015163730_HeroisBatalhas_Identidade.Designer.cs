...
namespace EFCore.webAPI2.Migrations
{
    ...
    [Migration("20201015163730_HeroisBatalhas_Identidade")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EFCore.webAPI2.Models.HeroiBatalha", b =>
                {
            ...
            modelBuilder.Entity("EFCore.webAPI2.Models.IdentidadeSecreta", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("EFCore.webAPI2.Models.IdentidadeSecreta", b =>
                {
                    b.HasOne("EFCore.webAPI2.Models.Heroi", "Heroi")
                        .WithOne("Identidade")
                        .HasForeignKey("EFCore.webAPI2.Models.IdentidadeSecreta", "HeroiId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
